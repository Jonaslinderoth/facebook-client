...

{
  ...
  "description": "Client for intercepting custom HTTP pixel requests from the \"Facebook Pixel - Server-Side\" Google Tag Manager custom template.",
  "containerContexts": [
    "SERVER"
  ]
}
...
[
  {
    "type": "LABEL",
    "name": "info",
    "displayName": "This client accepts requests from the \u003ca href\u003d\"https://tagmanager.google.com/gallery/#/owners/gtm-templates-simo-ahava/templates/facebook-pixel-server-side\"\u003eFacebook Pixel - Server-Side\u003c/a\u003e template in a Google Tag Manager \u003cstrong\u003eweb\u003c/strong\u003e container. The client builds the event object and runs the container with a custom \u003cstrong\u003efacebook\u003c/strong\u003e event. These should be used to trigger a tag built with the \u003cstrong\u003eFacebook\u003c/strong\u003e template in the \u003cstrong\u003eserver\u003c/strong\u003e container."
  }
]
...
let _fbc = getCookieValues('_fbc')[0];
...
if (getRequestPath() === '/fbq/') {
  ...
  if (!_fbc && params.fbclid) _fbc = params.fbclid;
...
scenarios:
- name: Container run successfully
  code: |-
...
- name: Container run with value from fbclid parameter
  code: |-
...
Created on 18/06/2020, 12:34:27
